...
Verizon rolled out the new plan at the time when consumers were switching from 3G networks to faster LTE networks so that they could tie the switch to shared data plans with the upgrade to better networks.

### Realiging price with shifting revenue drivers for Cellular Service Providers
